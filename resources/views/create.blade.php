...
<form method="post" action="{{route('store')}}" enctype="multipart/form-data">
    ...
    <div class="card-header my-4"><label for="" class="d-flex justify-content-center text-md-right">{{ __('Crear Producto') }}</label></div>
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" name="title" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required autocomplete="title" autofocus>
        </div>
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" name="price" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required autocomplete="price" autofocus>
        </div>

        <div class="input-group mb-3">
          <span class="input-group-text" id="inputGroup-sizing-default">Autor 1</span>
          <input type="text" name="author1" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required autocomplete="author1" autofocus>
        </div>
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" name="canReserve" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required autocomplete="canReserve" autofocus>
        </div>
      ...
      {{--  <div class="input-group mb-3">
        ...
        <div class="input-group mb-3">
          ...
          <input  type="file" class="form-control input-select" name="image1" id="image1" required autocomplete="image1" autofocus>
        </div>
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" name="format" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required autocomplete="format" autofocus>
        </div>
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" name="pages" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" required autocomplete="pages" autofocus>
        </div>
      <div>
